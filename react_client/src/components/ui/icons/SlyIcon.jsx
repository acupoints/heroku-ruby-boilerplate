...
class SlyIcon extends Component {
    ...
    render () {
        ...
        if (direction.toLowerCase()==="embedded") {
            ...
            } else if (pattern.toLowerCase()==="plus") {
                buttons = <>
                    <svg
                    width={size_x}
                    height={size_y}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <path
                                d="m 38.005081,194.06649 c -2.551694,0 -4.635126,2.13429 -4.635126,4.74818 v 60.86187 c 0,2.65754 2.083432,4.79031 4.635126,4.79031 h 59.412151 c 2.594248,0 4.679468,-2.13277 4.679468,-4.79031 v -60.86187 c 0,-2.61389 -2.08522,-4.74818 -4.679468,-4.74818 z M 65.1819,208.22461 h 5.060735 v 18.42747 H 88.27332 v 5.18487 H 70.242635 v 18.47182 H 65.1819 V 231.83695 H 47.191121 v -5.18487 H 65.1819 Z"
                                style={{fill: fill}}
                                />
                            </g>
                        </g>
            ...
            } else if (pattern.toLowerCase()==="okay") {
                buttons = <>
                    <svg
                    width={size_x}
                    height={size_y}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <path
                                d="m 67.712283,188.08253 c -21.966904,0 -39.897135,18.49846 -39.897135,41.16183 0,22.7073 17.930231,41.20645 39.897135,41.20645 22.009383,0 39.939227,-18.49915 39.939227,-41.20645 0,-22.66337 -17.929844,-41.16183 -39.939227,-41.16183 z m 18.226669,25.59955 3.612115,3.0246 -23.581724,27.79215 -3.399509,0.35005 -16.654254,-15.12285 2.974293,-3.50634 14.359863,12.53543 1.147195,-0.0872 z"
                                style={{fill: fill}}
                                />
                            </g>
                        </g>
            ...
            } else if (pattern.toLowerCase()==="reload") {
                buttons = <>
                    <svg
                    width={size_x}
                    height={size_y}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <path
                                d="m 45.809264,190.37789 -10.938751,19.42168 -10.941019,19.4671 10.941019,19.42168 10.938751,19.4671 h 21.925205 21.922932 l 10.938739,-19.4671 10.94102,-19.42168 -10.94102,-19.4671 -10.938739,-19.42168 H 67.734469 Z m 32.080177,10.44805 c -19.482695,10.26902 -1.873588,6.92078 -12.987918,13.66264 l -9.284874,7.3652 -3.966576,10.13679 0.218096,12.99247 c 0,0 -13.205139,-20.71869 7.628736,-39.11368 l 8.194402,-3.83935 z m 5.709046,12.7244 c 0,0 13.251033,20.67179 -7.626451,39.1114 l -8.194405,3.83934 -10.200407,1.20637 c 19.482743,-10.3137 1.875451,-6.96545 13.033353,-13.66269 l 9.239438,-7.36744 3.966568,-10.13455 z"
                                style={{fill: fill}}
                                />
                            </g>
                        </g>
